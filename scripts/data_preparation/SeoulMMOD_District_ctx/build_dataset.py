"""Augment a SeoulMMOD district-scale dataset with a holiday-state channel.

Output: datasets/SeoulMMOD_District_{year}_ctx/
...
Reads:
  datasets/SeoulMMOD_District_{year}/{data.dat, desc.json, od_pairs.json}
...
def main() -> None:
    ...
    out = REPO / 'datasets' / f'SeoulMMOD_District_{args.year}_ctx'
    ...
    new_desc = dict(desc)
    new_desc['name'] = f'SeoulMMOD_District_{args.year}_ctx'
