...
INPUT_LEN = 6   # override for short-horizon benchmark
OUTPUT_LEN = 6
...
MODEL_PARAM = {
    ...
    'down_sampling_layers': 1,  # h=6 too short for 3 downsamples (6/2/2/2 < 1)
    'top_k': 5,
...
CFG = EasyDict()
CFG.DESCRIPTION = 'TimeMixer on SeoulMMOD_District_2024 (district-scale, per-OD-pair, 6 interacting modes as variates, all 625 pairs, h=6)'
CFG.GPU_NUM = 1
