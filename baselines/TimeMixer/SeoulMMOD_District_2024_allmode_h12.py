...
MODEL_PARAM = {
    ...
    'down_sampling_layers': 2,  # h=12 -> 12/2=6, 6/2=3 (2 layers OK)
    'top_k': 5,
...
CFG = EasyDict()
CFG.DESCRIPTION = 'TimeMixer on SeoulMMOD_District_2024 (district-scale, per-OD-pair, 6 interacting modes as variates, all 625 pairs, h=12)'
CFG.GPU_NUM = 1
