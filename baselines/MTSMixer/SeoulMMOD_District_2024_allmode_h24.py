...
MODEL_PARAM = {
    ...
    "dec_in": 6,
    "d_model": 64,
    # MTSMixer channel mixing requires factorized_dim < enc_in.
    "d_ff": 4,
    "use_norm": True,
    "e_layers": 4,
    "fac_T": False,
...
CFG = EasyDict()
CFG.DESCRIPTION = "MTSMixer on SeoulMMOD_District_2024 (district-scale, per-OD-pair, 6 interacting modes as variates, all 625 pairs, h=24)"
CFG.GPU_NUM = 1
