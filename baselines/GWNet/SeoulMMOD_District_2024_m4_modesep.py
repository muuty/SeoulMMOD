...
NUM_EPOCHS = 100
CFG = EasyDict()
CFG.DESCRIPTION = "GWNet mode-sep m4"
CFG.GPU_NUM = 1
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints", "GWNet_m4_modesep", "_".join([DATA_NAME, str(NUM_EPOCHS), str(INPUT_LEN), str(OUTPUT_LEN)]))
