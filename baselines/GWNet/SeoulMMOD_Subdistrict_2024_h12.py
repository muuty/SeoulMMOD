...
from .arch import GraphWaveNetMulti
...
MODEL_ARCH = GraphWaveNetMulti
MODEL_PARAM = {
    'num_nodes': 181476,
    'output_len': OUTPUT_LEN,
    'num_modes': 6,
    'supports': None,                # adaptive-only mode (no predefined adjacency)
    'gcn_bool': True,
    'addaptadj': True,
    'aptinit': None,
    'in_dim': 6,                      # 6 mode flow channels
...
CFG = EasyDict()
CFG.DESCRIPTION = 'GWNet (multi-mode) on SeoulMMOD_Subdistrict_2024, h=12'
CFG.GPU_NUM = 1
