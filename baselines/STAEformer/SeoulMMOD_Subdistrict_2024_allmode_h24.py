"""STAEformer on subdistrict-scale SeoulMMOD_Subdistrict_2024 (all-mode joint, 181476 nodes).
...
CFG = EasyDict()
CFG.DESCRIPTION = 'STAEformer on SeoulMMOD_Subdistrict_2024 subdistrict-scale (OOM probe, 181476 nodes, h=24)'
CFG.GPU_NUM = 1
