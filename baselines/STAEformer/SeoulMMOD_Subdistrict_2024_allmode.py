"""STAEformer on sub-district-scale SeoulMMOD_Subdistrict_2024 (all-mode joint, 181476 nodes).
...
CFG = EasyDict()
CFG.DESCRIPTION = 'STAEformer on SeoulMMOD_Subdistrict_2024 sub-district-scale (OOM probe, 181476 nodes)'
CFG.GPU_NUM = 1
