"""STAEformer on Dong-level SeoulMOD_2024 (all-mode joint, 181476 nodes).

OOM test: ST models are typically designed for small N. This config attempts
the full Dong-level all-mode setting to probe the OOM boundary.
"""
import os
import sys
import numpy as np
...
CFG = EasyDict()
CFG.DESCRIPTION = 'STAEformer on SeoulMOD_2024 Dong-level (OOM probe, 181476 nodes)'
CFG.GPU_NUM = 1
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    'checkpoints',
    MODEL_ARCH.__name__ + '_allmode_2024_dong',
