...
DATA_NAME = "SeoulMMOD_District_2024_m0"
...
MODEL_PARAM = {
    "num_nodes": 625, "in_steps": INPUT_LEN, "out_steps": OUTPUT_LEN,
...
NUM_EPOCHS = 100
CFG = EasyDict()
CFG.DESCRIPTION = "STAEformer mode-sep m0"
CFG.GPU_NUM = 1
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints", "STAEformer_modesep_2024", "_".join([DATA_NAME, str(NUM_EPOCHS), str(INPUT_LEN), str(OUTPUT_LEN)]))
...
CFG.TRAIN.LR_SCHEDULER.PARAM = {"milestones": [25, 50, 75], "gamma": 0.5}
