...
# Dataset SeoulMMOD_District_2024_rain has 10 channels: 6 modes, rain_o=6, rain_d=7, tod=8, dow=9.
# rain_o (origin district hourly rain) and rain_d (dest district hourly rain) each get their
# own Conv2d projection added to the encoder hidden representation.
CFG = build_config(
    dataset_name='SeoulMMOD_District_2024_rain',
